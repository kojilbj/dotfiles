#!/usr/bin/env bash
# Generated from kvndrsslr/sketchybar-app-font `mappings/` source data.
# Usage: __icon_map "$app_name"; result in $icon_result (a ligature
# string like ":wezterm:" that the sketchybar-app-font's GSUB feature
# substitutes into the app's glyph when rendered with that font.
